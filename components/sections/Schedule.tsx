  ...
  const events = [
    {
      ...
      desc: "Buổi lễ đính hôn được tổ chức trong không khí thân mật, ấm cúng cùng sự hiện diện của gia đình hai bên.",
    ...
    },
    {
      ...
      desc: "Khoảnh khắc thiêng liêng khi cô dâu và chú rể chính thức nên duyên vợ chồng, trước sự chứng kiến của người thân và bạn bè.",
      image: "/wedding.jpg",
    },
    {
      title: "Tiệc Cưới",
      ...
      desc: "Bữa tiệc tràn ngập niềm vui, âm nhạc và lời chúc phúc dành cho đôi uyên ương trong ngày trọng đại.",
      image: "/party.jpg",
    },
  ];
    ...
    >
      ...
      <div className="relative z-10 py-30 px-6 md:px-12 text-center">
        ...
        <motion.h1
          ...
          className="test text-5xl md:text-6xl font-bold mb-1 font-bold"
          style={{ color: "#DC143C" }}
        >
          Lịch Trình Cưới
        </motion.h1>
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-10">
          {schedules &&
            schedules.map((event: any, index: number) => (
              <motion.div
                key={event.id}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed text-justify">{event.desc}</p>
                </div>
              </motion.div>
            ))}
        </div>
