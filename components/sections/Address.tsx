    ...
    return (
        ...
        >
            ...
            <div className="p-8 flex-grow flex flex-col">
                ...
                <Button
                    onClick={onNavigate}
                    className={`cursor-pointer mt-auto w-full py-8 text-lg font-bold rounded-2xl transition-all duration-300 shadow-lg hover:shadow-2xl active:scale-95 ${isPink
